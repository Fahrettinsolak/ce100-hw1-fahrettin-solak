...
namespace ce100_hw1_algo_test_cs
{
    ...
    public class UnitTest1
    {
        ...
        public void NaivePow_test()
        {
            ...
            int result = Class1.Naivepower(8, 2);
        ...
        public void NaivePow_testMinus()
        {
            ...
            int result = Class1.Naivepower(-5, 1);
        ...
        public void NaivePow_test0()
        {
            ...
            int result = Class1.Naivepower(4, 0);
            Assert.AreEqual(result, 1);
        ...
        {
            int[] Arr1 = { 11, 23, 61, 39, 59, 40 };
            int[] result = { 11, 23, 39, 40, 59, 61 };
